...
class ProgressTracker:
    ...
    async def mark_domain_processed(self, domain: str, status: str,
                                  result: Optional[Dict[str, Any]] = None,
                                  error_message: Optional[str] = None,
                                  processing_time: Optional[float] = None,
                                  scrape_mode: Optional[str] = None) -> None:
    ...
    def get_successful_domains(self) -> List[str]:
        ...
        return [
            domain for domain, data in self.progress_data["processed_domains"].items()
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        if self.progress_data["start_time"]:
            ...
            if processed > 0:
                ...
                summary["estimated_time_remaining"] = str(timedelta(seconds=int(estimated_remaining)))
